...
import 'package:moda/response/jadwal_respone.dart';
import 'package:http/http.dart' as http;

class ApiJadwalService {
  Future<JadwalResponse> fetchJadwals(int page) async {
    ...
    final response = await http.get(
      Uri.parse(NetworkURL.getJadwal(page)),
      headers: {
    ...
    if (response.statusCode == 200) {
      ...
      print(responseBody);
      return JadwalResponse.fromJson(responseBody['data']);
    } else {
      throw Exception('Failed to load jadwals');
    }
  }
}
