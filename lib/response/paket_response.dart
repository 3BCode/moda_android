...
class PaketResponse {
  ...
  factory PaketResponse.fromJson(Map<String, dynamic> json) {
    List<PaketModel> dataList = [];
    if (json['data'] != null) {
      List<dynamic> list = json['data'].cast<dynamic>();
      dataList = list.map((i) => PaketModel.fromJson(i)).toList();
    }
