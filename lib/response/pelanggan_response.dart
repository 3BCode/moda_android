...
class PelangganResponse {
  ...
  final List<PelangganModel> data;
  ...
  factory PelangganResponse.fromJson(Map<String, dynamic> json) {
    List<PelangganModel> dataList = [];
    if (json['data'] != null) {
      List<dynamic> list = json['data'].cast<dynamic>();
      dataList = list.map((i) => PelangganModel.fromJson(i)).toList();
    }
